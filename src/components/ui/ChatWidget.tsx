      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100 dark:border-white/10">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-mint-300 to-mint-600 p-[2px]">
              <img src="/logo.png" className="w-full h-full rounded-full object-cover bg-white dark:bg-[#0E0E11] p-1" alt="Assistant Avatar" />
            </div>
            <span className="font-bold text-lg text-blacktext dark:text-white font-montserrat">Assistant</span>
          </div>
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6 flex flex-col font-montserrat relative scroll-smooth">
          ...
          <div className="flex flex-col gap-1 max-w-[85%] animate-fade-up">
            <div className="bg-gray-50 dark:bg-white/5 text-blacktext dark:text-gray-200 p-4 rounded-2xl rounded-tl-sm text-[15px] leading-relaxed border border-gray-100 dark:border-white/10 shadow-sm">
              ...
              <p className="mb-4">Need answers or help with your to-do list? I've got you covered!</p>
              <p>Just type what you need, and let's dive into making things happen.</p>
            </div>
          </div>
          ...
          <div className="flex gap-2 max-w-[90%] self-end group relative flex-row-reverse animate-fade-up">
            <div className="bg-mint-50 dark:bg-mint-900/30 text-blacktext dark:text-gray-200 p-4 rounded-2xl rounded-tr-sm text-[15px] leading-relaxed border border-mint-100 dark:border-mint-800/50 shadow-sm">
              Create me a CSV of the top 20 SaaS companies by revenue that have raised capital in the last 12 months.
            </div>
            {/* Hover Actions */}
            <div className="absolute -bottom-5 right-4 bg-zinc-800 text-gray-300 rounded-lg shadow-md px-2 py-1.5 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 z-10 border border-zinc-700">
              <button className="hover:text-white" title="Improve"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg></button>
              <button className="hover:text-white" title="Edit"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" /></svg></button>
              <button className="hover:text-white" title="Retry"><svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5"><path strokeLinecap="round" strokeLinejoin="round" d="M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" /></svg></button>
          ...
          <div className="flex flex-col gap-2 max-w-[85%] mt-6 animate-fade-up">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-3 flex items-center justify-between text-white shadow-md w-full hover:bg-zinc-800 transition-colors cursor-pointer group">
              <div className="flex items-center gap-3">
                <div className="bg-[#1e7b54] text-white text-[10px] tracking-wider font-bold rounded p-2 flex items-center justify-center">CSV</div>
                <span className="text-sm font-medium truncate group-hover:underline">Top_20_SaaS_Companies.csv</span>
              </div>
          ...
          <div className="flex gap-2 max-w-[90%] self-end flex-row-reverse mt-4 animate-fade-up">
            <div className="bg-mint-50 dark:bg-mint-900/30 text-blacktext dark:text-gray-200 p-4 rounded-2xl rounded-tr-sm text-[15px] leading-relaxed border border-mint-100 dark:border-mint-800/50 shadow-sm">
              Actually, filter by U.S. companies only and include details of fundraising. Export into a new Google Sheet for me.
            </div>
          </div>
          ...
          <div className="flex gap-2 max-w-[85%] mt-2 animate-fade-up">
            <div className="bg-gray-50 dark:bg-white/5 p-4 rounded-2xl rounded-tl-sm flex gap-1.5 items-center border border-gray-100 dark:border-white/10 shadow-sm h-12">
              <div className="w-1.5 h-1.5 bg-mint-500 rounded-full animate-bounce" style={{ animationDelay: '0ms' }}></div>
              <div className="w-1.5 h-1.5 bg-mint-500 rounded-full animate-bounce" style={{ animationDelay: '150ms' }}></div>
              <div className="w-1.5 h-1.5 bg-mint-500 rounded-full animate-bounce" style={{ animationDelay: '300ms' }}></div>
            </div>
          </div>
        ...
        <div className="p-4 border-t border-gray-100 dark:border-white/10 bg-white dark:bg-[#0E0E11]">
          <div className="relative flex items-center">
            ...
            <button className="absolute right-3 p-1 text-gray-400 hover:text-mint-500 dark:hover:text-mint-400 transition-colors flex items-center justify-center">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
